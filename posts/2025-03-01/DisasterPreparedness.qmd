...
# Load the raster
raster_path <- "posts/2025-03-01/ESA_landcover_clip.tif"
...
```{r, echo=FALSE, message=FALSE, warning=FALSE} m}
```
...
trees_raster_path <- "posts/2025-03-01/trees_close_tohomes.tif"
...
```{r}
 #  Load the Trees Raster  
neighborhoods <- "posts/2025-03-01/forest_risk_stats_zonal.shp"
...
```{=html}
<iframe src="https://eliceorg.github.io/CONS-327-Test/" width="100%" height="800px"></iframe>
```